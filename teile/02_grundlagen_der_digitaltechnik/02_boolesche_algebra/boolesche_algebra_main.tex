...
\lernziel{\autoref{ch:boolesche-algebra}, \nameref{ch:boolesche-algebra}}{
\begin{minipage}{\linewidth}
$\square$ \hspace{0.1cm} Sie nennen für die drei Logikgatter \texttt{UND}, \texttt{ODER} und \texttt{NICHT} jeweils die boolesche Operation.\\
$\square$ \hspace{0.1cm} Sie notieren für jedes der drei Logikgatter den booleschen Operator.\\
$\square$ \hspace{0.1cm} Sie stellen das Verhalten für jedes der drei Logikgatter als boolesche Formel dar.
\end{minipage}
}
