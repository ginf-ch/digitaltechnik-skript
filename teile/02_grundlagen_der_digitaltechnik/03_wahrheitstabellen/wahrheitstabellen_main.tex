...
\lernziel{\autoref{ch:wahrheitstabellen}, \nameref{ch:wahrheitstabellen}}{
\begin{minipage}{\linewidth}
$\square$ \hspace{0.1cm} Sie erklären, was wir unter einer Wahrheitstabelle verstehen.\\
$\square$ \hspace{0.1cm} Sie notieren für jedes der drei Logikgatter (\texttt{UND}, \texttt{ODER} und \texttt{NICHT}) die Wahrheitstabelle.
\end{minipage}
}
