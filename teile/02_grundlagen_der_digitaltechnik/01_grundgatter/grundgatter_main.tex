...
\lernziel[\autoref{part:grundlagen-digitaltechnik}, Grundlagen der Digitaltechnik]{\autoref{ch:grundgatter}, \nameref{ch:grundgatter}}{
\begin{minipage}{\linewidth}
$\square$ \hspace{0.1cm} Sie erklären, was wir unter einem Logikgatter verstehen.\\
$\square$ \hspace{0.1cm} Sie erklären anhand eines Beispiels das Verhalten der drei Logikgatter \texttt{UND}, \texttt{ODER} und \texttt{NICHT}.\\
$\square$ \hspace{0.1cm} Sie stellen die drei Logikgatter \texttt{UND}, \texttt{ODER} und \texttt{NICHT} grafisch dar.
\end{minipage}
}
