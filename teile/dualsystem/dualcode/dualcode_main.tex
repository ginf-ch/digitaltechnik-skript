...
\begin{todolist}
\item Sie definieren den Begriff Binärziffer.
\item Sie definieren den Begriff Binärzahl.
\item Sie definieren den Begriff Dualzahl.
\item Sie erklären die Begriffe Codieren und Decodieren an einem Beispiel.
...
Der \textbf{Dualcode} wandelt eine natürliche Dezimalzahl in eine binäre Ziffernfolge um und umgekehrt. Das Umwandeln einer natürlichen Dezimalzahl in eine Dualzahl bezeichnen wir als \textbf{Codieren} von natürlichen Dezimalzahlen. Die Umkehrung bezeichnen wir als \textbf{Decodieren} von Dualzahlen.
