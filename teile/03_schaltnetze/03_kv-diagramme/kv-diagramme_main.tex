...
\lernziel{\autoref{ch:kv-diagramme}, \nameref{ch:kv-diagramme}}{
\begin{minipage}{\linewidth}
$\square$ \hspace{0.1cm} Sie erstellen eine vereinfachte boolesche Formel in \ac{DNF} mithilfe eines \acs{KV}-Diagramms.
\end{minipage}
}
...
Wir können für \textbf{jede} Wahrheitstabelle eine vereinfachte boolesche Formel erstellen.
...
Erstellen Sie pro \textbf{Übung} und \textbf{Ausgang} die \textbf{vereinfachte boolesche Formel} in \ac{DNF} mithilfe eines \ac{KV}-Diagramms. Wählen Sie das korrekte \ac{KV}-Diagramm aus und stellen Sie die Blöcke \textbf{sauber} dar.
